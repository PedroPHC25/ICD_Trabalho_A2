...
p1.line('year', 'wind_energy_per_capita', line_width=6, line_color="#0C3B40", source=source)

p1.title.text_font = "Georgia"  # Altera a fonte do título para Georgia
p1.title.text_font_size = "14pt"  # Altera o tamanho da fonte do título para 14 pontos
p1.title.text_color = "#0C3B40"  # Altera a cor do texto do título para vermelho
...
p1.xaxis.axis_label_text_color = "#0C3B40"  # Altera a cor do texto do rótulo do eixo x para azul
...
p1.yaxis.axis_label_text_color = "#0C3B40"  # Altera a cor do texto do rótulo do eixo y para verde
p1.yaxis.major_label_text_font_style = "bold"  # Colocando em negrito os rótulos das escalas do eixo y

p1.background_fill_color = "#38ABF2"  # Altera a cor de fundo do gráfico 
...
p2.title.text_color = "#0C3B40"  # Altera a cor do texto do título 
...
p2.xaxis.axis_label_text_color = "#0C3B40"  # Altera a cor do texto do rótulo do eixo x 
...
p2.yaxis.axis_label_text_color = "#0C3B40"  # Altera a cor do texto do rótulo do eixo y 
p2.yaxis.major_label_text_font_style = "bold"  # Colocando em negrito os rótulos das escalas do eixo y

p2.background_fill_color = "#38ABF2"  # Altera a cor de fundo do gráfico
...
p3.title.text_color = "#0C3B40"  # Altera a cor do texto do título 
...
p3.xaxis.axis_label_text_color = "#0C3B40"  # Altera a cor do texto do rótulo do eixo x 
...
p3.yaxis.axis_label_text_color = "#0C3B40"  # Altera a cor do texto do rótulo do eixo y para verde
p3.yaxis.major_label_text_font_style = "bold"  # Colocando em negrito os rótulos das escalas do eixo y

p3.background_fill_color = "#38ABF2"  # Altera a cor de fundo do gráfico
