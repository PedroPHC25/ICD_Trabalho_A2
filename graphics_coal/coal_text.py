...
text_grid_graph = Div(text ="""<p style="text-align:justify; font-size:16px;">O objetivo desse gráfico é criar uma comparação na evolução dos anos entre os continentes e seu consumo de energia primária a partir do carvão, os continentes escolhidos foram: América do Norte, Europa, América do Sul e Central e África.
    ...
    <p style="text-align:justify; font-size:16px;">Para esse gráfico tive de escolher os continentes com os melhores dados, e mesmo assim a base de dados tem um desfalque entre 1965 a 1980, tentei buscar fontes complementares mas não obtive sucesso.</p>
...
text_stackedbar = Div(text ="""<p style="text-align:justify; font-size:16px;">Essa visualização trás um acumulativo das atividades do carvão em alguns países no ano de 1995, entre os aspectos estão consumo, produção de carvão e geração de eletricidade. O tipo de mensagem desse gráfico é a comparação nominal, por isso foi escolhido a representação em barras que permite maior precisão na interpretação.</p>
...
<p style="text-align:justify; font-size:16px;">Novamente ocorre uma dominância da China nesse setor, especificamente a partir de 1986. Isso deve-se em parte à mudança do gás para o carvão motivada pelos preços altíssimos do gás. Outro fator determinante é a queda na qualidade do carvão extraído, o que significa que usinas e fábricas tiveram que queimar mais carvão para obter a mesma quantidade de energia.</p>

<b> Autora: Mariana Fernandes Rocha </b>
