...
# Criando a figura
wind_ratio_figure = figure(height=600, 
                           width=1200, 
...
wind_ratio_figure.scatter(x='wind_elec_per_capita', 
...
slope, intercept, r_value, p_value, std_err = stats.linregress(df_filtered_year_2000['wind_elec_per_capita'], 
                                                               df_filtered_year_2000['wind_energy_per_capita'])

# Criando a reta de regressão
x_line = np.array([df_filtered_year_2000['wind_elec_per_capita'].min(), 
                   df_filtered_year_2000['wind_elec_per_capita'].max()])
y_line = slope * x_line + intercept
regression_line = Slope(gradient=slope, 
...
# Criando a figura
wind_ratio_figure_new_scale = figure(height=600, 
                                     width=1200, 
                                     title="RATIO BETWEEN WIND ELECTRICITY AND WIND ENERGY (BOTH PER CAPITA)", 
                                     tools = "pan, wheel_zoom, reset, hover, save",
                                     tooltips = [("País", "@country")])
