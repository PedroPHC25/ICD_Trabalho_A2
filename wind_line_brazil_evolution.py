...
wind_line_brazil_evolution_graph = figure(title="PER CAPITA CONSUMPTION OF ELECTRICITY GENERATED BY WIND IN BRAZIL IN THE LAST 50 YEARS",
                                          x_axis_label='YEAR', 
                                          y_axis_label='WIND ENERGY CONSUMPTION (kWh)', 
                                          width=1200, 
                                          height=600)

# Plotando o gráfico de linha:
wind_line_brazil_evolution_graph.line('year', 
                                      'wind_energy_per_capita', 
                                      line_width=6, 
                                      line_color="#8A5556", 
                                      source=df_wind_graph_line)
...
wind_line_brazil_evolution_graph.title.align = "center"  #Alinhando o título no centro do gráfico
...
wind_line_brazil_evolution_graph.add_layout(Label(x=2016, 
                                                  y=500,
                                                  text=text,
                                                  text_align="right",
                                                  text_font_size="12px",
...
annotation = BoxAnnotation(left=2010, 
                           right=2020, 
                           fill_color='#D49495', 
                           fill_alpha=0.3)
