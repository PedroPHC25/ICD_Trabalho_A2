...
wind_text_1 = Div(text = """</br> </p>Neste primeiro conjunto de dados construído pela função grid temos 6 análises que comparam a alteração 
...
</p> Quanto a parte técnica, temos 6 gráficos de linhas plotados em um grid de duas linhas e três colunas (2x3). 
...
wind_text_2 = Div(text = """</br> </p> Nesta segunda visualização temos um gráfico de barras que mostra os nove países que lideram o ranking do 
...
</p>Além disso, fiz um agrupamento por continente. Os países de um mesmo continente estão preenchidos com a mesma 
...
</p>Quanto a parte técnica, temos um gráficos de barras plotado usando recursos do bokeh. As cores foram escolhidas 
...
wind_text_3 = Div(text = """</br> </p>Nesta terceira peça de visualização temos um segundo grid. Nesse caso, temos o mesmo gráfico plotando em 
...
</p>Quanto a parte técnica, temos dois gráficos de dispersão plotados usando recursos do bokeh. As cores foram 
...
wind_text_4 = Div(text = """</br> </p> Por último, mas não menos importante temos mais um gráfico de linhas. Este representa a evolução do Brasil, ao 
longo dos últimos 50 anos, quanto ao consumo per capita de energia eólica.  </p> </br>

</p> O gráfico mostra que esse consumo se manteve praticamente constante até o final da década de 2000. O começo da
...
</p> Quanto a parte técnica, temos um gráfico de linha plotado usando recursos do bokeh. As cores foram escolhidas
